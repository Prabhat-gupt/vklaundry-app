...
class SettingsScreen extends StatelessWidget {
        ...
        child: Column(
          ...
          children: [
              ...
              child: const Row(
                children: [
                  const CircleAvatar(
                    ...
                    child: Image(
                      image: AssetImage('assets/icons/setting_profile.png'),
                      fit: BoxFit.cover,
                    ),
                  ),
                  SizedBox(width: 16),
            ...
            _buildInfoCard([
              ...
              _DashedDivider(),
              _buildListTile(Icons.location_on_outlined, "Saved Address",
                  onTap: () {
            ...
            _buildInfoCard([
              ...
              _DashedDivider(),
              _buildListTile(Icons.info_outline, "General Info",onTap: () {
                Get.toNamed('/profile_screen');
              }),
            ]),
  ...
  Widget _buildListTile(IconData icon, String title, {required Null Function() onTap}) {
    return ListTile(
