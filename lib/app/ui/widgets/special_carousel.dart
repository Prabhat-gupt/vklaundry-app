              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                        ...
                        children: [
                          ...
                          Column(
                            ...
                            children: [
                              Row(
                                children: [
                                  Icon(Icons.checkroom_rounded, size: 16.sp, color: Colors.grey[600]),
                                  SizedBox(width: 6.w),
                                  Text(
                                    "${sub['pieces']} pieces",
                                    style: TextStyle(
                              ...
                              Row(
                                children: [
                                  Icon(Icons.calendar_today_rounded, size: 16.sp, color: Colors.grey[600]),
                                  SizedBox(width: 6.w),
                                  Text(
                    ...
                    SizedBox(height: 16.h), // Extra padding above the safe area bottom
                  ],
                ),
              ),
            ],
